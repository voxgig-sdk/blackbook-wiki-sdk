# BlackbookWiki SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions BlackbookWikiSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both BlackbookWikiSDK(...) and BlackbookWikiSDK.test(...) become
#      BlackbookWikiSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "blackbookwiki_sdk"
_SDK_CLASS = "BlackbookWikiSDK"
