...
class BlackbookWikiTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = BlackbookWikiTestRunner.getenv("BLACKBOOKWIKI_TEST_LIVE")
        override = BlackbookWikiTestRunner.getenv("BLACKBOOKWIKI_TEST_OVERRIDE")
        ...
        explain = BlackbookWikiTestRunner.getenv("BLACKBOOKWIKI_TEST_EXPLAIN")
