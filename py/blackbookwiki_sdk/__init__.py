...
from blackbookwiki_sdk.utility import register

# Load features
from blackbookwiki_sdk.feature.base_feature import BlackbookWikiBaseFeature
from blackbookwiki_sdk.features import _has_feature, _make_feature
...
class BlackbookWikiSDK:
    ...
    def get_utility(self):
        return BlackbookWikiUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("BlackbookWikiSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Person(self, data=None) -> "PersonEntity":
        ...
        from blackbookwiki_sdk.entity.person_entity import PersonEntity
        return PersonEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "BlackbookWikiSDK":
        if sdkopts is None:
            sdkopts = {}
