...
|---|---|---|
| `ts/` | @voxgig-sdk/blackbook-wiki-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/blackbook-wiki-sdk \
      --repository voxgig-sdk/blackbook-wiki-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/blackbook-wiki-sdk` shows it, and
`npm trust revoke @voxgig-sdk/blackbook-wiki-sdk --id=<id>` removes it.
