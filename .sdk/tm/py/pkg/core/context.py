...
from projectname_sdk.core.control import BlackbookWikiControl
...
class BlackbookWikiContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = BlackbookWikiControl()
        ...
        if isinstance(sp, BlackbookWikiSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, BlackbookWikiResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, BlackbookWikiResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return BlackbookWikiError(code, msg, self)
