...
// BlackbookWiki SDK rbac feature
...
class BlackbookWikiRbacFeature extends BlackbookWikiBaseFeature
{
    ...
    private function _required(BlackbookWikiContext $ctx): ?string
    {
    ...
    private function _reject(BlackbookWikiContext $ctx, string $required): void
    {
    ...
    private function _track(BlackbookWikiContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
