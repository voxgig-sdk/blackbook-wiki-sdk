...
// BlackbookWiki SDK timeout feature
...
class BlackbookWikiTimeoutFeature extends BlackbookWikiBaseFeature
{
    ...
    private function _with_timeout(BlackbookWikiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(BlackbookWikiContext $_ctx, float $ms): void
    {
        $client = $this->client;
