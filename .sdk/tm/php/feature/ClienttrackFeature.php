...
// BlackbookWiki SDK clienttrack feature
...
class BlackbookWikiClienttrackFeature extends BlackbookWikiBaseFeature
{
    ...
    public function PostConstruct(BlackbookWikiContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'BlackbookWiki-SDK';
