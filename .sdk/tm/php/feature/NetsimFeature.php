...
// BlackbookWiki SDK netsim feature
...
class BlackbookWikiNetsimFeature extends BlackbookWikiBaseFeature
{
    ...
    private function _simulate(BlackbookWikiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(BlackbookWikiContext $ctx, array $applied): void
    {
        $client = $this->client;
