...
// BlackbookWiki SDK utility: fetcher

class BlackbookWikiFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; BlackbookWikiSDK/1.0)';
    ...
    public static function call(BlackbookWikiContext $ctx, string $fullurl, array $fetchdef): array
    {
