...
// BlackbookWiki SDK utility type

class BlackbookWikiUtility
{
    ...
    public static function copy(BlackbookWikiUtility $src): BlackbookWikiUtility
    {
        $u = new BlackbookWikiUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
