...
function runner.env_override(m)
  local live = runner.getenv("BLACKBOOKWIKI_TEST_LIVE")
  local override = runner.getenv("BLACKBOOKWIKI_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("BLACKBOOKWIKI_TEST_EXPLAIN")
