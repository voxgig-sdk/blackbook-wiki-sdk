...
function runner.env_override(m)
  local live = runner.getenv("BLACKBOOK_WIKI_TEST_LIVE")
  local override = runner.getenv("BLACKBOOK_WIKI_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("BLACKBOOK_WIKI_TEST_EXPLAIN")
