...
describe("PersonEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set BLACKBOOKWIKI_TEST_PERSON_ENTID JSON to run live")
      return
    end
...
function person_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("BLACKBOOKWIKI_TEST_PERSON_ENTID")
  ...
  if env["BLACKBOOKWIKI_TEST_LIVE"] == "TRUE" then
  ...
  local live = env["BLACKBOOKWIKI_TEST_LIVE"] == "TRUE"
  return {
    client = client,
    data = entity_data,
