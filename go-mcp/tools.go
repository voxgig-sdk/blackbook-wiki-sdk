...
type Args struct {
	Entity string         `json:"entity" jsonschema:"person"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.BlackbookWikiSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "blackbook-wiki_list",
		Description: "List records from BlackbookWiki. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "blackbook-wiki_load",
		Description: "Load a single record from BlackbookWiki. " +
...
func runOp(client *sdk.BlackbookWikiSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.BlackbookWikiSDK, name string) (sdk.BlackbookWikiEntity, error) {
