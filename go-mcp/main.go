// Command BlackbookWiki-mcp is an MCP server exposing the BlackbookWiki
// SDK as MCP tools.
//
// Two tools are registered:
//
//	BlackbookWiki_list  — list records of an entity
//	BlackbookWiki_load  — load a single record of an entity
//
