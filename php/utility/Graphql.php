...
// BlackbookWiki SDK utility: graphql
//
...
class BlackbookWikiGraphql
{
    ...
    // equivalent.
    public static function body(BlackbookWikiContext $ctx): mixed
    {
    ...
    public static function errors(BlackbookWikiContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
