...
// BlackbookWiki SDK pipeline test
//
...
require_once __DIR__ . '/../blackbookwiki_sdk.php';
...
{
    private static function utility(): BlackbookWikiUtility
    {
        return new BlackbookWikiUtility();
    }
    ...
    private static function ctx(array $over = []): BlackbookWikiContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new BlackbookWikiContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new BlackbookWikiOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof BlackbookWikiError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new BlackbookWikiOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = BlackbookWikiMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new BlackbookWikiOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = BlackbookWikiMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new BlackbookWikiOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = BlackbookWikiMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new BlackbookWikiSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = BlackbookWikiMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new BlackbookWikiResponse([]),
            'result' => new BlackbookWikiResult([]),
        ]);
        [, $err] = BlackbookWikiMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new BlackbookWikiSpec([]),
            'response' => null,
            'result' => new BlackbookWikiResult([]),
        ]);
        [, $err] = BlackbookWikiMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new BlackbookWikiSpec(['step' => 's']),
            'response' => new BlackbookWikiResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new BlackbookWikiResult([]),
        ]);
        [, $err] = BlackbookWikiMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new BlackbookWikiSpec(['step' => 's']),
            'response' => new BlackbookWikiResponse(self::resp(200, ['v' => 1])),
            'result' => new BlackbookWikiResult([]),
        ]);
        [, $err] = BlackbookWikiMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new BlackbookWikiSpec(['step' => 's']),
            'response' => new BlackbookWikiResponse(self::resp(200, ['v' => 2])),
            'result' => new BlackbookWikiResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        BlackbookWikiMakeResponse::call($ctx);
    ...
    {
        $preset = new BlackbookWikiResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new BlackbookWikiSpec([]),
            'response' => new BlackbookWikiResponse([]),
            'result' => new BlackbookWikiResult([]),
        ...
        [$got, $err] = BlackbookWikiMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new BlackbookWikiResult([])]);
        [, $err] = BlackbookWikiMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new BlackbookWikiSpec([]), 'result' => null]);
        [, $err] = BlackbookWikiMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new BlackbookWikiSpec(['step' => 's']),
            'result' => new BlackbookWikiResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new BlackbookWikiOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = BlackbookWikiMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new BlackbookWikiSpec(['step' => 's']),
            'result' => new BlackbookWikiResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new BlackbookWikiOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = BlackbookWikiMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new BlackbookWikiResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new BlackbookWikiSpec([]),
            'result' => new BlackbookWikiResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = BlackbookWikiMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = BlackbookWikiMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new BlackbookWikiError('boom', 'boom');
        $utility->fetcher = function (BlackbookWikiContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new BlackbookWikiSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = BlackbookWikiMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (BlackbookWikiContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = BlackbookWikiMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(BlackbookWikiResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        BlackbookWikiMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (BlackbookWikiContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new BlackbookWikiSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = BlackbookWikiMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new BlackbookWikiResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new BlackbookWikiSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = BlackbookWikiMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = BlackbookWikiMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = BlackbookWikiMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new BlackbookWikiResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, BlackbookWikiDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new BlackbookWikiResult(['ok' => false])]);
        $this->expectException(BlackbookWikiError::class);
        BlackbookWikiDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new BlackbookWikiResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', BlackbookWikiMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        BlackbookWikiMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new BlackbookWikiBaseFeature();
        $b = new BlackbookWikiBaseFeature();
        BlackbookWikiFeatureAdd::call($ctx, $a);
        BlackbookWikiFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): BlackbookWikiBaseFeature
    {
        $f = new BlackbookWikiBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        BlackbookWikiFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): BlackbookWikiContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new BlackbookWikiSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = BlackbookWikiPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        BlackbookWikiPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new BlackbookWikiResponse(['headers' => null]),
            'result' => new BlackbookWikiResult([]),
        ]);
        BlackbookWikiResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        BlackbookWikiResultBody::call($ctx);
