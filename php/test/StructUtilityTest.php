...
// BlackbookWiki SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = BlackbookWikiOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(BlackbookWikiOmni::structfix($now, Struct::undef()))
                        !== json_encode(BlackbookWikiOmni::structfix($val, Struct::undef()))) {
