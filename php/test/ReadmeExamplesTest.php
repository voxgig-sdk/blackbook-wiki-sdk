...
// BlackbookWiki SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (BlackbookWikiSDK::test)
...
{
    private const SDK_CLASS = 'BlackbookWikiSDK';
    ...
    private const SDK_BASE = 'blackbookwiki_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../blackbookwiki_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
