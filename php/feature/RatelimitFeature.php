...
// BlackbookWiki SDK ratelimit feature
...
class BlackbookWikiRatelimitFeature extends BlackbookWikiBaseFeature
{
    ...
    private function _acquire(BlackbookWikiContext $ctx): void
    {
    ...
    private function _track(BlackbookWikiContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
