...
// BlackbookWiki SDK cache feature
...
class BlackbookWikiCacheFeature extends BlackbookWikiBaseFeature
{
    ...
    private function _through(BlackbookWikiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
