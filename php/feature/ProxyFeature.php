...
// BlackbookWiki SDK proxy feature
...
class BlackbookWikiProxyFeature extends BlackbookWikiBaseFeature
{
    ...
    public function init(BlackbookWikiContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (BlackbookWikiContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
