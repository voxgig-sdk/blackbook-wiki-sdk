...
// BlackbookWiki SDK audit feature
...
class BlackbookWikiAuditFeature extends BlackbookWikiBaseFeature
{
    ...
    private function _emit(BlackbookWikiContext $ctx, string $outcome): void
    {
