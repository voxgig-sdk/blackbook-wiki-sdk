# BlackbookWiki Golang SDK Reference

Complete API reference for the BlackbookWiki Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *BlackbookWikiSDK`
...
#### `Person(data map[string]any) BlackbookWikiEntity`
...
| --- | --- | --- | --- |
| `cases` | `[]any` | No | List of cases associated with the person |
