...
#      offline in seeded test mode (BlackbookWikiSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "BlackbookWiki_sdk.rb")
  SDK_CLASS = "BlackbookWikiSDK"
