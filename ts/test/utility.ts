...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.BLACKBOOKWIKI_TEST_LIVE ||
    'TRUE' === process.env.BLACKBOOKWIKI_TEST_OVERRIDE
  ) {
  ...
  m.BLACKBOOKWIKI_TEST_EXPLAIN = process.env.BLACKBOOKWIKI_TEST_EXPLAIN || m.BLACKBOOKWIKI_TEST_EXPLAIN
