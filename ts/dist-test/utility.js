...
function envOverride(m) {
    if ('TRUE' === process.env.BLACKBOOK_WIKI_TEST_LIVE ||
        'TRUE' === process.env.BLACKBOOK_WIKI_TEST_OVERRIDE) {
    ...
    m.BLACKBOOK_WIKI_TEST_EXPLAIN = process.env.BLACKBOOK_WIKI_TEST_EXPLAIN || m.BLACKBOOK_WIKI_TEST_EXPLAIN;
    return m;
}
