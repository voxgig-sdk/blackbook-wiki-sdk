...
(0, node_test_1.describe)('PersonDirect', async () => {
    ...
    (0, node_test_1.afterEach)((0, utility_1.liveDelay)('BLACKBOOK_WIKI_TEST_LIVE'));
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.BlackbookWikiSDK({
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.BlackbookWikiSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {}));
        let idmap = env['BLACKBOOK_WIKI_TEST_PERSON_ENTID'];
    ...
    const client = new __1.BlackbookWikiSDK({
        base: 'http://localhost:8080',
