# BlackbookWiki TypeScript SDK Reference

Complete API reference for the BlackbookWiki TypeScript SDK.
...
```ts
new BlackbookWikiSDK(options?: object)
```
...
#### `BlackbookWikiSDK.test(testopts?, sdkopts?)`
...
**Returns:** `BlackbookWikiSDK` instance in test mode.
...
Alias for `BlackbookWikiSDK.test()`.
...
Return the parent `BlackbookWikiSDK` instance.
