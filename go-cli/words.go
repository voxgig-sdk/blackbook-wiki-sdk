...
func registerSDKWords(r *eng.Registry, client *sdk.BlackbookWikiSDK) {
...
func runOp(client *sdk.BlackbookWikiSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
