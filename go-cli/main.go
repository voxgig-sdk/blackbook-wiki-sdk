// Command BlackbookWiki-cli is a CLI + REPL for the BlackbookWiki SDK,
...
const prompt = "blackbook-wiki"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "person"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      BLACKBOOK_WIKI_APIKEY (api key), BLACKBOOK_WIKI_BASE (base url override)")
...
func run(args []string, in io.Reader, out, errOut io.Writer) int {
	...
	// Configure from the environment: BLACKBOOK_WIKI_APIKEY carries the API key and
	// BLACKBOOK_WIKI_BASE optionally overrides the API base URL (e.g. production).
	// Both injectable by a secrets vault. Unset -> nil config defaults.
	var opts map[string]any
	if apikey := os.Getenv("BLACKBOOK_WIKI_APIKEY"); apikey != "" {
		opts = map[string]any{"apikey": apikey}
	}
	if base := os.Getenv("BLACKBOOK_WIKI_BASE"); base != "" {
		if opts == nil {
			opts = map[string]any{}
		}
		opts["base"] = base
	}
	client := sdk.NewBlackbookWikiSDK(opts)
